<template>
    ...
    >
      ...
      <el-table-column prop="name" label="管理员" width="200" />
  ...
  <script lang="ts" setup>
    ...
    function save(){
      ...
      var params = { isAdmin: form.admin }
  
      if(fromTitle.value === "新增管理员"){
        form.id = -1
